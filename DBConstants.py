class DBConstants:
    ...
    get_history_bets   = 'SELECT idAposta, dataAposta, valorApostado FROM Aposta WHERE idUser=%s AND numeroJogos=1;'
    get_history_bets_m = 'SELECT idAposta, dataAposta, valorApostado FROM Aposta WHERE idUser=%s AND numeroJogos>1;'
